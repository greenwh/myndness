<script lang="ts">
	 ...
	 *
	 * Shows item details, progress chart, and exposure history
	 */
	...
	import HierarchyDetail from '$lib/components/cbt/HierarchyDetail.svelte';
...
<svelte:head>
	<title>Hierarchy Item - Myndness</title>
</svelte:head>
...
<div class="page-container">
	...
	{:else}
		...
		<div class="page-header">
			<a href="{base}/tools/cbt/hierarchy" class="back-button" aria-label="Back to hierarchy">
			...
			<h1 class="page-title">Hierarchy Item</h1>
		</div>

		<HierarchyDetail {item} onRefresh={refreshItem} />
	{/if}
</div>
